...
module.exports = new Locale({ //INFO
    ...
    [
        ...
        },
        {
            category: 'locale',
            name: 'updatingLocale',
            message: '{0} Changing your server\'s locale.. this may take a moment.',
        },
        {
            category: 'locale',
        ...
        },
        {
            category: 'watching',
            name: 'fetching',
            message: '{0} Fetching all the users that are watching YouTube.. this may take a while.',
        },
        {
            category: 'watching',
            name: 'fetchFail',
            message: 'Failed to fetch all the users watching YouTube. If this problem persists, let the team know at <https://discord.gg/nnpPGRy>.',
        },
        {
            category: 'lyrics',
            name: 'noArgs',
